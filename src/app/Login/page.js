      ...
      <div className='border-2 border-white-600 w-1/3 h-[350px] rounded-xl'>
          ...
          </select>
          {
            (selectLogin==="Student") ?(
              ...
              <input className='w-4/5 bg-secondary text-black border-1 border-white-600 ml-[30px] text-[22px] placeholder:text-black' type={`email`} placeholder='Student id' />
